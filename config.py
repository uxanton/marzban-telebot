...
XRAY_SUBSCRIPTION_URL_PREFIX = config("XRAY_SUBSCRIPTION_URL_PREFIX", default="http://vm3513985.24ssd.had.wf:8000/").strip("/")
...
TELEGRAM_DEFAULT_VLESS_XTLS_FLOW = config("TELEGRAM_DEFAULT_VLESS_XTLS_FLOW", default="")
